<?php 
	...
	*/
	class Usuario extends DB
	{
		...
		public function getMail($user_id = null){
			if(!is_null($user_id)){
				$sel = $this->prepare(self::USUARIO_GET_MAIL);
				$sel->bindParam(':id',$user_id, PDO::PARAM_INT);
				$sel->execute();
				return $sel->fetch()->mail;
			}
		}
