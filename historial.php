	...
	<div class="historial-productos col-xs-12 col-sm-12 col-md-12 ol-lg-12">
		...
		<div class="acordeon-general panel-group" id="accordion">
			...
			<div class="item">
				...
				<!--head accordeon-->
				<a data-toggle="collapse" data-target="#collapse<?php echo $keycompras;?>" aria-expanded="true" aria-controls="collapse<?php echo $keycompras;?>" >
				...
				<!--body accordeon-->
				<div id="collapse<?php echo $keycompras;?>" class="collapse in">
