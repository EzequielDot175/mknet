<?php ob_start(); session_start(); error_reporting(0); include_once('../resources/control.php'); header('Content-Type: text/html; charset=utf-8');
...
header('Location: '.BASEURL.'usuarios/e_usuario.php?id='.$idUsuario.'&activo=2&sub=e&vert=1');
?>