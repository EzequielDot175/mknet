...
$sql = "INSERT INTO productos ( strNombre,strDetalle,intCategoria,dblPrecio,intStock,intMinCompra,intMaxCompra,strImagen,strImagen2,strImagen3,destacado,message ) VALUES ( '$this->strNombre','$this->strDetalle','$this->intCategoria','$this->dblPrecio','$this->intStock','$this->intMinCompra','$this->intMaxCompra','$this->strImagen','$this->strImagen2','$this->strImagen3','$this->destacado','$this->message')";
$result = $this->database->query($sql);
