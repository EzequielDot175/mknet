...
echo '<div class="menuorden">
<a href="v_usuarios.php?orden=1"><img src="../layout/btn-orden1.jpg" alt="desc"/></a><a href="v_usuarios.php?orden=2"><img src="../layout/btn-orden2.jpg" alt="desc"/></a></div>';
/* SELECT */
...
<div class="one_4"><h4>Opciones</h4>
		...
		<ul class="menusidebar">
			...
			<li><a class="active" href="n_<?php echo $singular; ?>.php">Crear cliente</a></li>
